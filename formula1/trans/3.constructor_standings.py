...
constructor_rank_spec = Window.partitionBy('race_year').orderBy(desc('total_points'), desc('wins')) # Two tier ranking incase of tie. Uses total wins to break
...
# %sql
#  -- Run this if getting casting error in next step
